...
deck: "The full distance is a season you pay for in sleep, and at this age recovery is the account the training draws on."
date: "2024-11-03"
tags: ["recovery", "sleep", "full distance", "midlife"]
dos:
  - "Set the bedtime first and let the alarm follow from it, because the 4:30 workout only exists if 8:30 p.m. does."
  - "Put the easy week on the calendar before the hard weeks, so it can't get skipped when the hard weeks are going well."
  - "After a long race, take the recovery you'd make a friend take, since you wouldn't let a buddy run a tempo four days after a marathon."
  - "Pay attention to how you feel at the 5 a.m. alarm and not only what the watch says, because the alarm usually knows first."
donts:
  - "Don't borrow from sleep to add a session, because after 45 that session costs more than it gives back, every time."
  - "Don't turn the full distance into an identity, since it's a season with a start and a finish, and the finish is a good thing."
