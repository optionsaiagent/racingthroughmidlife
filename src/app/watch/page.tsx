...
export const metadata: Metadata = {
  title: "Watch",
  description: "Every Racing Through Midlife video by season: the 2023 weekly vlog, the race recaps, and the year-in-review films. The channel is the camera and the site is the log.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        deck="The site is for the sentences that should still be here in three years, and the videos are for everything else: the bike rack at 4:45 a.m., the finish chute, the blooper reel. Here they all are, by season."
      >
        <p className="mt-6">
