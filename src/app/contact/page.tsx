...
export const metadata: Metadata = {
  title: "Contact",
  description: "How to reach Jay and Michelle. Race photos, official times, and 'we did this too' notes are welcome, and coaching requests and medical questions get a polite no.",
};

export default function Contact() {
  return (
    <>
      <PageHeader eyebrow="Contact" title="If you've got the official time, send it and we'll put it up." deck="One email address, read by two people, usually after a workout and before the coffee's gone." />
      <div className="mx-auto max-w-6xl px-5 sm:px-8 grid gap-10 md:grid-cols-2 max-w-4xl">
        <div className="bg-foam border border-line p-6">
          ...
          <p className="mt-4 text-sm text-ink-soft">
            We answer anything that&apos;s a person writing to a person, and we don&apos;t answer pitches for electrolytes.
          </p>
        </div>
        <div className="bg-foam border border-line p-6">
        ...
        <div className="md:col-span-2 grid sm:grid-cols-2 gap-6 pt-4">
          ...
          <div>
            ...
            <ul className="mt-2 text-[0.98rem] space-y-1.5">
              <li>Coaching, since we don&apos;t coach and we&apos;re not going to start.</li>
              <li>Medical questions, because we don&apos;t know your labs.</li>
              <li>Sponsorships, affiliate offers, gear to review.</li>
              <li>Anything about mortgages. Jay has a day job with its own website, and this isn&apos;t it.</li>
            </ul>
          </div>
        </div>
      </div>
